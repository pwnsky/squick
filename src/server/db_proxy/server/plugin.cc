...
void DBNet_ServerPlugin::Install() { REGISTER_MODULE(pm_, IDBNet_ServerModule, DBNet_ServerModule) }

void DBNet_ServerPlugin::Uninstall() { UNREGISTER_MODULE(pm_, IDBNet_ServerModule, DBNet_ServerModule) }