...
void MysqlPlugin::Install() { REGISTER_MODULE(pPluginManager, IMysqlModule, MysqlModule) }

void MysqlPlugin::Uninstall() { UNREGISTER_MODULE(pPluginManager, IMysqlModule, MysqlModule) }