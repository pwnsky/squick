...
void Plugin::Install() { REGISTER_MODULE(pPluginManager, IHttpModule, HttpModule) }

void Plugin::Uninstall() { UNREGISTER_MODULE(pPluginManager, IHttpModule, HttpModule) }
