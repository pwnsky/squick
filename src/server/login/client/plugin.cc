...
void Plugin::Install() { REGISTER_MODULE(pPluginManager, IMasterModule, MasterModule) }

void Plugin::Uninstall() { UNREGISTER_MODULE(pPluginManager, IMasterModule, MasterModule) }
