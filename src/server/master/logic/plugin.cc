...
void MasterServerPlugin::Install() { REGISTER_MODULE(pm_, IMasterModule, MasterModule) }

void MasterServerPlugin::Uninstall() { UNREGISTER_MODULE(pm_, IMasterModule, MasterModule) }
