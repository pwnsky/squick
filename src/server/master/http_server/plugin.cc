...
void MasterNet_HttpServerPlugin::Install() { REGISTER_MODULE(pPluginManager, IMasterNet_HttpServerModule, MasterNet_HttpServerModule) }

void MasterNet_HttpServerPlugin::Uninstall() { UNREGISTER_MODULE(pPluginManager, IMasterNet_HttpServerModule, MasterNet_HttpServerModule) }