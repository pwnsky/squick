...
void MasterNet_ServerPlugin::Install() { REGISTER_MODULE(pm_, IMasterNet_ServerModule, MasterNet_ServerModule) }

void MasterNet_ServerPlugin::Uninstall() { UNREGISTER_MODULE(pm_, IMasterNet_ServerModule, MasterNet_ServerModule) }