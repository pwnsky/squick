...
void Plugin::Install() {
	REGISTER_MODULE(pPluginManager, IGameplayManagerModule, GameplayManagerModule)
}

void Plugin::Uninstall() {
	UNREGISTER_MODULE(pPluginManager, IGameplayManagerModule, GameplayManagerModule)
}
