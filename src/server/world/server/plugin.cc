...
void WorldNet_ServerPlugin::Install() { REGISTER_MODULE(pm_, IWorldNet_ServerModule, WorldNet_ServerModule) }

void WorldNet_ServerPlugin::Uninstall() { UNREGISTER_MODULE(pm_, IWorldNet_ServerModule, WorldNet_ServerModule) }