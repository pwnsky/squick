...
void Plugin::Install() { REGISTER_MODULE(pm_, IHttpServerModule, HttpServerModule) }

void Plugin::Uninstall() { UNREGISTER_MODULE(pm_, IHttpServerModule, HttpServerModule) }
