...
void Plugin::Install() { REGISTER_MODULE(pm_, IClickhouseModule, ClickhouseModule) }

void Plugin::Uninstall() { UNREGISTER_MODULE(pm_, IClickhouseModule, ClickhouseModule) }
