...
class CommonRedisModule : public ICommonRedisModule {
  ...
  public:
    ...
    virtual bool GetRecordInfo(const std::string &self, const std::string &className, rpc::ObjectRecordList *pRecordData, const bool cache, const bool save);
    ...
    // bool save);
    static bool ConvertRecordManagerToPB(const std::shared_ptr<IRecordManager> pRecordManager, rpc::ObjectRecordList *pRecordDataList, const bool cache,
                                         const bool save) {
