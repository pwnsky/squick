...
void Plugin::Install() { REGISTER_MODULE(pm_, IPlayerManagerModule, PlayerManagerModule) }

void Plugin::Uninstall() { UNREGISTER_MODULE(pm_, IPlayerManagerModule, PlayerManagerModule) }
