...
void Tutorial6::Install() { REGISTER_MODULE(pPluginManager, IHelloWorld6, HelloWorld6) }

void Tutorial6::Uninstall() { UNREGISTER_MODULE(pPluginManager, IHelloWorld6, HelloWorld6) }