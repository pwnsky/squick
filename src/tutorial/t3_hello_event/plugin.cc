...
void Tutorial3Plugin::Install() { REGISTER_MODULE(pm_, IHelloEventModule, HelloEventModule) }

void Tutorial3Plugin::Uninstall() { UNREGISTER_MODULE(pm_, IHelloEventModule, HelloEventModule) }
