...
void Tutorial4Plugin::Install() { REGISTER_MODULE(pm_, IHelloWorld4Module, HelloWorld4Module) }

void Tutorial4Plugin::Uninstall() { UNREGISTER_MODULE(pm_, IHelloWorld4Module, HelloWorld4Module) }
