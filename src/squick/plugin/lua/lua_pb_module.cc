...
bool LuaPBModule::ReadyUpdate() { return true; }
...
LuaIntf::LuaRef LuaPBModule::GetRepeatedFieldElement(const google::protobuf::Message &message, const google::protobuf::FieldDescriptor *field,
                                                     int index) const {
    if (!field->is_repeated()) {
        return LuaIntf::LuaRef();
    }
...
void LuaPBModule::AddToMapField(google::protobuf::Message &message, const google::protobuf::FieldDescriptor *field, const LuaIntf::LuaRef &key,
