...
void NoSqlPlugin::Install() { REGISTER_MODULE(pPluginManager, INoSqlModule, NoSqlModule) }

void NoSqlPlugin::Uninstall() { UNREGISTER_MODULE(pPluginManager, INoSqlModule, NoSqlModule) }