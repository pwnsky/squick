...
void Property::SetValue(const IProperty* property)
{
...
const SQUICK_SHARE_PTR<List<std::string>> Property::GetEmbeddedList() const
{
	return this->mxEmbeddedList;
}

const SQUICK_SHARE_PTR<MapEx<std::string, std::string>> Property::GetEmbeddedMap() const
{
