...
#define SQUICK_SMART_ENUM(EnumName, ...)                                                                                                                       \
    class EnumName {                                                                                                                                           \
      public:                                                                                                                                                  \
        EnumName() : value(0) {}                                                                                                                               \
      ...
      public:                                                                                                                                                  \
        ...
        std::string toString(void) const { return toString(value); }                                                                                           \
        static std::string toString(int aInt) { return nameMap()[aInt]; }                                                                                      \
        static EnumName fromString(const std::string &s) {                                                                                                     \
            auto it = find_if(nameMap().begin(), nameMap().end(), [s](const std::pair<int, std::string> &p) { return p.second == s; });                        \
            if (it == nameMap().end()) {                                                                                                                       \
                /*value not found*/                                                                                                                            \
