  ...
  <div class="analysis">
    <a-row style="margin-top: 0" :gutter="[24, 24]">
      <a-col :sm="24" :md="12" :xl="6">
        <chart-card :loading="loading" :title="$t('今日已登录设备')" total="5台">
          <a-tooltip :title="$t('introduce')" slot="action">
            <a-icon type="info-circle-o" />
          </a-tooltip>
          <div>
            <trend style="margin-right: 16px" :term="$t('登录次数')" :percent="12" :is-increase="true" :scale="0" />
            <trend :term="$t('  ')" :target="100" :value="89" :scale="0" />
          </div>
          <div slot="footer">{{$ta('平均在线时长')}}<span> 15 小时</span></div>
        </chart-card>
      </a-col>
      <a-col :sm="24" :md="12" :xl="6">
        <chart-card :loading="loading" :title="$t('在线设备')" total="15台">
          <a-tooltip :title="$t('introduce')" slot="action">
            <a-icon type="info-circle-o" />
          </a-tooltip>
          <div>
      ...
      <a-col :sm="24" :md="12" :xl="6">
        <chart-card :loading="loading" :title="$t('已经激活设备')" total="20个">
          <a-tooltip :title="$t('introduce')" slot="action">
            <a-icon type="info-circle-o" />
          </a-tooltip>
          <div>
