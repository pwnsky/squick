...
class DataList : public MemoryCounter {
  ...
  public:
    ...
    virtual bool Append(const DataList &src) { return Append(src, 0, src.GetCount()); }
    ...
    virtual bool Append(const SquickData &xData) {
        if (xData.GetType() <= TDATA_UNKNOWN || xData.GetType() >= TDATA_MAX) {
            return false;
        }
    ...
    virtual bool IsEmpty() const { return (0 == mnUseSize); }

    virtual int GetCount() const { return mnUseSize; }
    ...
    inline int Int32(const int index) const { return (int)Int(index); }
    ...
    bool AddInt(const INT64 value) { return Add(value); }
    bool AddFloat(const double value) { return Add(value); }
    bool AddString(const std::string &value) { return Add(value); }
    bool AddStringFromChar(const char *value) { return Add(value); }
    bool AddObject(const Guid &value) { return Add(value); }
    bool AddVector2(const Vector2 &value) { return Add(value); }
    bool AddVector3(const Vector3 &value) { return Add(value); }

    bool SetInt(const int index, const INT64 value) { return Set(index, value); }
    bool SetFloat(const int index, const double value) { return Set(index, value); }
    bool SetString(const int index, const std::string &value) { return Set(index, value); }
    bool SetObject(const int index, const Guid &value) { return Set(index, value); }
    bool SetVector2(const int index, const Vector2 &value) { return Set(index, value); }
    bool SetVector3(const int index, const Vector3 &value) { return Set(index, value); }

    inline bool Compare(const int nPos, const DataList &src) const {
        if (src.GetCount() > nPos && GetCount() > nPos && src.Type(nPos) == Type(nPos)) {
    ...
    inline bool operator!=(const DataList &src) { return !(*this == src); }
  ...
  protected:
    bool ValidIndex(int index) const { return (index < GetCount()) && (index >= 0); }
