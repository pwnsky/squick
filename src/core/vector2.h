...
class Vector2 {
  ...
  public:
    ...
    Vector2(const std::string &v) { FromString(v); }

    bool operator<(const Vector2 &v) const { return this->Length() < v.Length(); }
    ...
    bool operator==(const Vector2 &v) const { return std::abs(this->x - v.x) < 0.001f && std::abs(this->y - v.y) < 0.001f; }
    ...
    bool IsZero() const { return x < 0.001f && y < 0.001f; }

    //----------------------------------------------------------------------------
    inline float SquaredMagnitude() const { return x * x + y * y; }
    ...
    //----------------------------------------------------------------------------
    inline Vector2 Normalized() const { return Direction(); }
    ...
    std::string ToString() const { return lexical_cast<std::string>(x) + "," + lexical_cast<std::string>(this->y); }
