...
class WSModule : public IWSModule {
  public:
    ...
    virtual bool SendMsg(const int32_t msg_id, const char *msg, const size_t len, const socket_t sock /*= 0*/) override;
    virtual bool SendPBMsg(const uint32_t msg_id, const google::protobuf::Message &xData, const socket_t sock) override;
