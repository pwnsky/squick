...
sleep 0.5
./squick.sh type=web id=10 area=0 ip=127.0.0.1 port=10010 http_port=8888 master_ip=127.0.0.1 master_port=10001 logshow=0 &
sleep 0.5
...
sleep 0.5
./squick.sh type=login id=2 area=0 ip=127.0.0.1 port=10301 http_port=8088 master_ip=127.0.0.1 master_port=10001 logshow=0 &
sleep 0.5
