...
const uint32_t TableStruct_google_2fprotobuf_2futil_2finternal_2ftestdata_2fdefault_5fvalue_5ftest_2eproto::offsets[] PROTOBUF_SECTION_VARIABLE(protodesc_cold) = {
  ...
  PROTOBUF_FIELD_OFFSET(::proto_util_converter::testing::DefaultValueTest, _impl_.double_value_),
  PROTOBUF_FIELD_OFFSET(::proto_util_converter::testing::DefaultValueTest, _impl_.repeated_double_),
  PROTOBUF_FIELD_OFFSET(::proto_util_converter::testing::DefaultValueTest, _impl_.float_value_),
  PROTOBUF_FIELD_OFFSET(::proto_util_converter::testing::DefaultValueTest, _impl_.int64_value_),
  PROTOBUF_FIELD_OFFSET(::proto_util_converter::testing::DefaultValueTest, _impl_.uint64_value_),
  PROTOBUF_FIELD_OFFSET(::proto_util_converter::testing::DefaultValueTest, _impl_.int32_value_),
  PROTOBUF_FIELD_OFFSET(::proto_util_converter::testing::DefaultValueTest, _impl_.uint32_value_),
  PROTOBUF_FIELD_OFFSET(::proto_util_converter::testing::DefaultValueTest, _impl_.bool_value_),
  PROTOBUF_FIELD_OFFSET(::proto_util_converter::testing::DefaultValueTest, _impl_.string_value_),
  PROTOBUF_FIELD_OFFSET(::proto_util_converter::testing::DefaultValueTest, _impl_.bytes_value_),
  PROTOBUF_FIELD_OFFSET(::proto_util_converter::testing::DefaultValueTest, _impl_.enum_value_),
};
...
DefaultValueTest::DefaultValueTest(const DefaultValueTest& from)
  ...
  DefaultValueTest* const _this = this; (void)_this;
  new (&_impl_) Impl_{
  ...
  ::memcpy(&_impl_.double_value_, &from._impl_.double_value_,
    ...
    reinterpret_cast<char*>(&_impl_.double_value_)) + sizeof(_impl_.enum_value_));
...
void DefaultValueTest::MergeImpl(::PROTOBUF_NAMESPACE_ID::Message& to_msg, const ::PROTOBUF_NAMESPACE_ID::Message& from_msg) {
  auto* const _this = static_cast<DefaultValueTest*>(&to_msg);
  auto& from = static_cast<const DefaultValueTest&>(from_msg);
...
void DefaultValueTest::InternalSwap(DefaultValueTest* other) {
  ...
  ::PROTOBUF_NAMESPACE_ID::internal::memswap<
      PROTOBUF_FIELD_OFFSET(DefaultValueTest, _impl_.enum_value_)
      + sizeof(DefaultValueTest::_impl_.enum_value_)
      - PROTOBUF_FIELD_OFFSET(DefaultValueTest, _impl_.double_value_)>(
